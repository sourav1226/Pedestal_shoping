...
<section>
      <div className="min-h-180 flex items-center justify-center bg-white">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
          ...
          {/* Left Image */}
          <div className="bg-gray-50 rounded-2xl flex justify-center p-8">
            <img
              src="https://pedestaltechnoworld.com/front-end/asset/register-img/register-img.png"
              alt="signup"
              className="max-w-sm"
            />
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-500 mb-6">
              Create your Pedestal account to start learning
            </p>
            ...
            {/* Terms */}
            <label className="flex items-start gap-2 text-sm mb-6 font-medium">
            ...
            {/* Button */}
            <button className="w-full hover:bg-blue-800  bg-[#050978] text-white py-3 rounded-md font-semibold hover:opacity-90 transition">
              Sign up now
            </button>
            ...
            <p className="text-center text-sm mt-4 font-medium">
              ...
              <a href="Login" className="text-red-500 cursor-pointer ml-1">
                Login
              </a>
            </p>
          </div>
